...
- <code><a href="./resources/account-collection-flows.ts">AcccountConnectionFlow</a></code>

Methods:

- <code title="post /api/account_collection_flows">client.accountCollectionFlows.<a href="./resources/account-collection-flows.ts">create</a>({ ...params }) -> AcccountConnectionFlow</code>
- <code title="get /api/account_collection_flows/{id}">client.accountCollectionFlows.<a href="./resources/account-collection-flows.ts">retrieve</a>(id) -> AcccountConnectionFlow</code>
- <code title="patch /api/account_collection_flows/{id}">client.accountCollectionFlows.<a href="./resources/account-collection-flows.ts">update</a>(id, { ...params }) -> AcccountConnectionFlow</code>
- <code title="get /api/account_collection_flows">client.accountCollectionFlows.<a href="./resources/account-collection-flows.ts">list</a>({ ...params }) -> AcccountConnectionFlowsPage</code>
