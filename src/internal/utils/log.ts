...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: ModernTreasury): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: ModernTreasury): Logger {
