...
export class BulkResults extends APIResource {
   ...
   * list bulk_results
   */
  list(query: BulkResultListParams | null | undefined = {}, options?: RequestOptions): PagePromise<BulkResultsPage, BulkResult> {
...
export interface BulkResult {
   ...
   * `request_params`.
   */
  entity: PaymentOrdersAPI.PaymentOrder | ExpectedPaymentsAPI.ExpectedPayment | LedgerTransactionsAPI.LedgerTransaction | LedgerAccountsAPI.LedgerAccount | TransactionsAPI.Transaction | BulkResult.BulkError;
   ...
   */
  entity_type: 'payment_order' | 'ledger_account' | 'ledger_transaction' | 'expected_payment' | 'transaction' | 'entity_link' | 'transaction_line_item' | 'bulk_error';
