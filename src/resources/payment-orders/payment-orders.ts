...
export interface PaymentOrder {
   ...
   * @deprecated
   */
  accounting: LineItemsAPI.Accounting;
   ...
   * data.
   */
  current_hold: HoldsAPI.Hold | null;
...
export interface PaymentOrderAsyncCreate {
  /**
   * Value in specified currency's smallest unit. e.g. $10 would be represented as
   * 1000 (cents). For RTP, the maximum amount allowed by the network is $100,000.
   */
   ...
   */
  line_items?: Array<ExpectedPaymentsAPI.LineItem>;
   ...
   * internal account.
   */
  receiving_account?: PaymentOrderAsyncCreate.ReceivingAccount;
...
export namespace PaymentOrderAsyncCreate {
  /**
   * Either `receiving_account` or `receiving_account_id` must be present. When using
   * `receiving_account_id`, you may pass the id of an external account or an
   * internal account.
...
export interface PaymentOrderUpdate {
   ...
   * internal account.
   */
  receiving_account?: PaymentOrderUpdate.ReceivingAccount;
...
export namespace PaymentOrderUpdate {
  /**
   * Either `receiving_account` or `receiving_account_id` must be present. When using
   * `receiving_account_id`, you may pass the id of an external account or an
   * internal account.
...
export interface PaymentOrderCreateParams {
   ...
   */
  documents?: Array<DocumentsAPI.DocumentCreate>;
