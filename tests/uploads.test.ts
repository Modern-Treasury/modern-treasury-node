import fs from 'fs';
import type { ResponseLike } from 'modern-treasury/internal/to-file';
import { toFile } from 'modern-treasury/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('modern-treasury/core/uploads');
    await expect(
