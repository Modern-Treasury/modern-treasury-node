...
describe('resource virtualAccounts', () => {
  test('create: only required params', async () => {
    const responsePromise = client.virtualAccounts.create({ internal_account_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', name: 'name' });
  ...
  test('update: request options and params are passed correctly', async () => {
    ...
    await expect(client.virtualAccounts.update('id', {
    counterparty_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
  ...
  test('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.virtualAccounts.list({
