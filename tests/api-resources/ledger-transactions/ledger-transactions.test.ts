...
describe('resource ledgerTransactions', () => {
  test('create: only required params', async () => {
    const responsePromise = client.ledgerTransactions.create({ ledger_entries: [{
    amount: 0,
    direction: 'credit',
  ...
  test('update: request options and params are passed correctly', async () => {
    ...
    await expect(client.ledgerTransactions.update('id', {
    description: 'description',
    effective_at: '2019-12-27T18:11:19.117Z',
    external_id: 'external_id',
    ledger_entries: [{
  ...
  test('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.ledgerTransactions.list({
    id: ['string'],
  ...
  test('createPartialPost: only required params', async () => {
    const responsePromise = client.ledgerTransactions.createPartialPost('id', { posted_ledger_entries: [{
    amount: 0,
    direction: 'credit',
    ledger_account_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
  }] });
  ...
  test('createReversal: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.ledgerTransactions.createReversal('id', {
    description: 'description',
    effective_at: '2019-12-27T18:11:19.117Z',
    external_id: 'external_id',
    ledgerable_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
