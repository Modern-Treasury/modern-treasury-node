...
describe('resource paymentOrders', () => {
  ...
  test.skip('create: required and optional params', async () => {
    ...
    originating_account_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    type: 'ach',
    accounting: { account_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', class_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' },
  ...
  test('update: request options and params are passed correctly', async () => {
    ...
    await expect(client.paymentOrders.update('id', {
    accounting: { account_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', class_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e' },
    accounting_category_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    accounting_ledger_class_id: '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    amount: 0,
  ...
  test('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.paymentOrders.list({
