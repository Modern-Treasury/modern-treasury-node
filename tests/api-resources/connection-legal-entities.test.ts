...
describe('resource connectionLegalEntities', () => {
  ...
  test('create: required and optional params', async () => {
    ...
    verification_time: '2019-12-27T18:11:19.117Z',
    comment: 'comment',
  },
  ...
  test('update: request options and params are passed correctly', async () => {
    ...
    await expect(client.connectionLegalEntities.update('id', { status: 'processing' }, { path: '/_stainless_unknown_path' }))
      .rejects
  ...
  test('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.connectionLegalEntities.list({
