          ...
          anyOf: [
                  ...
                  properties: {
                    ...
                    ledger_account: {
                      ...
                      properties: {
                        ...
                        normal_balance: {
                          $ref: '#/properties/resources/items/anyOf/0/ledger_transaction/ledger_entries/items/direction',
                        },
                        currency_exponent: {
                          type: 'integer',
            ...
            },
            {
              ...
              properties: {
                ...
                currency: {
                  $ref: '#/properties/resources/items/anyOf/0/currency',
                },
                date_lower_bound: {
                  type: 'string',
              ...
              properties: {
                ...
                receiving_account: {
                  ...
                  properties: {
                    ...
                    account_type: {
                      $ref: '#/properties/resources/items/anyOf/0/receiving_account/account_type',
                    },
                    contact_details: {
                      type: 'array',
                      items: {
                ...
                subtype: {
                  $ref: '#/properties/resources/items/anyOf/0/subtype',
                },
                type: {
                  $ref: '#/properties/resources/items/anyOf/0/type',
                },
                ultimate_originating_party_identifier: {
                  type: 'string',
                  description:
            ...
            },
            {
              ...
              properties: {
                ...
                reconciliation_rule_variables: {
                  ...
                  description: 'An array of reconciliation rule variables for this payment.',
                  items: {
                    $ref: '#/properties/resources/items/anyOf/1/reconciliation_rule_variables/items',
                  },
                },
                remittance_information: {
                  type: 'string',
                ...
                type: {
                  $ref: '#/properties/resources/items/anyOf/1/type',
                },
              },
              required: [],
            },
