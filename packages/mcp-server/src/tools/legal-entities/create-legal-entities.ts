...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
          ...
          properties: {
            ...
            child_legal_entity: {
              ...
              properties: {
                ...
                compliance_details: {
                  $ref: '#/properties/compliance_details',
                },
                date_formed: {
                  type: 'string',
                  description: "A business's formation date (YYYY-MM-DD).",
                ...
                industry_classifications: {
                  ...
                  description: 'A list of industry classifications for the legal entity.',
                  items: {
                    $ref: '#/properties/industry_classifications/items',
                  },
                },
                last_name: {
                  type: 'string',
      ...
      wealth_and_employment_details: {
        $ref: '#/properties/legal_entity_associations/items/child_legal_entity/wealth_and_employment_details',
      },
      website: {
        type: 'string',
        description: "The entity's primary website URL.",
...
export const handler = (client: ModernTreasury, args: any) => {
  const { ...body } = args;
  return client.legalEntities.create(body);
};
