...
export const tool: Tool = {
  name: 'create_legal_entity_associations',
  description: 'create legal_entity_association',
  inputSchema: {
    type: 'object',
    properties: {
...
export const handler = async (client: ModernTreasury, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await client.legalEntityAssociations.create(body));
  } catch (error) {
