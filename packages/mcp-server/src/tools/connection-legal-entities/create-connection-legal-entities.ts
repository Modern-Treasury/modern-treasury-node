...
export const tool: Tool = {
  name: 'create_connection_legal_entities',
    ...
    properties: {
      ...
      legal_entity: {
        ...
        properties: {
              ...
              properties: {
                ...
                child_legal_entity: {
                  ...
                  properties: {
                    ...
                    bank_settings: {
                      $ref: '#/properties/legal_entity/bank_settings',
                    },
                    business_name: {
                      type: 'string',
                      description: "The business's legal business name.",
                    ...
                    compliance_details: {
                      $ref: '#/properties/legal_entity/compliance_details',
                    },
                    date_formed: {
                      type: 'string',
                      description: "A business's formation date (YYYY-MM-DD).",
                    ...
                    industry_classifications: {
                      ...
                      description: 'A list of industry classifications for the legal entity.',
                      items: {
                        $ref: '#/properties/legal_entity/industry_classifications/items',
                      },
                    },
                    last_name: {
                      type: 'string',
          ...
          wealth_and_employment_details: {
            $ref: '#/properties/legal_entity/legal_entity_associations/items/child_legal_entity/wealth_and_employment_details',
          },
          website: {
            type: 'string',
            description: "The entity's primary website URL.",
...
export const handler = (client: ModernTreasury, args: any) => {
  const { ...body } = args;
  return client.connectionLegalEntities.create(body);
};
